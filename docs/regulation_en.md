...
1.4. Legal Nature of the Project
    ...
    2. The Project is implemented within a decentralized Web3 approach and uses blockchain as its technological foundation.
...
A diversified portfolio including indices, stocks, bonds, commodities, metals, and other assets.
...
Section 5. Treasury and Allocation of Funds
5.1. Purpose
...
Section 6. PICoin Economic Model
...
6.2. Total Supply
    • total supply: 150,000,000,000,000 (150 trillion) PIC;
    • additional issuance is impossible.
6.3. Distribution
    • 45 trillion PIC — ICO and charter capital;
    • 60 trillion PIC — gradual sale over 5–6 years;
    • 45 trillion PIC — Project needs (marketing, listings, airdrops, rewards, development).
...
7.6. Exit
    ...
    • there are no restrictions on exit; liquidity is not guaranteed.
7.7. Risks
